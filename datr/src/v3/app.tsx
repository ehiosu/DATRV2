        ...
        <Routes>
          ...
          <Route element={<CPDLayout />}>
            ...
            <Route
              ...
              element={
                <ProtectedRoute roles={["ADMIN", "FOU", "TERMINAL_SUPERVISOR"]}>
                  <SlaEdit />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  roles={["ADMIN", "AIRLINE", "ADMIN", "DATA_STATISTICS"]}
                >
                  <FligthDisruption />
                </ProtectedRoute>
              }
            ...
            >
              ...
              />
              <Route
                path="/CPD/Configuration/user_groups/"
                element={
                  <ProtectedRoute roles={["ADMIN"]}>
                    <GroupView />
                  </ProtectedRoute>
              ...
              />
              <Route
                path="/CPD/Configuration/User/:agent"
                element={
                  <ProtectedRoute roles={["ADMIN"]}>
                    <CPOView />
                  </ProtectedRoute>
              ...
              />
              <Route
                path="/CPD/Configuration/Terminals"
                element={
                  <ProtectedRoute roles={["ADMIN"]}>
              ...
              />
              <Route
                path="/CPD/Configuration/Airlines"
                element={
                  <ProtectedRoute roles={["ADMIN"]}>
          ...
          <Route element={<DasLayout />}>
            ...
            <Route
              path="/DAS/Dashboard"
              element={
                <ProtectedRoute roles={["DGO", "ADMIN", "DATA_STATISTIC"]}>
                  <DASDashboard />
                </ProtectedRoute>
              }
            />
