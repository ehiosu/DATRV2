...
export const CreateBaseAccount = () => {
  ...
  return (
    <>
      {asAirline ? (
        <AirlineRegistration setAsAirline={setAsAirline} />
      ) : (
        <Signup setAsAirline={setAsAirline} />
      )}
    </>
  );
};
export const Signup = ({
  ...
  return (
    <main className="bg-ncBlue flex justify-center w-full h-screen relative">
      <img
        src={
          "https://res.cloudinary.com/dpxuxtdbh/image/upload/v1715615431/asseco-ncaa/ncaalogo_hklh3e.png"
        }
        alt=""
        className="absolute   left-8   w-[10vw] aspect-square top-8 "
      />
      <div
        onClick={() => {
          nav("/");
      ...
      >
        <ArrowLeft className="w-5 h-5 shrink" />
      </div>
      <div className="pt-4 pb-8 px-10 bg-[#FFFFFF] h-max flex w-[35%] mt-[12vh] rounded-xl border-[1px] border-[#B9B9B9] flex-col max-h-screen">
        <p className="font-[600] text-center text-2xl font-nunito-sans w-full">
          Create an Account
        </p>
        ...
        <Form {...form}>
          ...
          >
            ...
            <button
              className="w-full h-8 grid place-items-center disabled:bg-neutral-400 disabled:hover:bg-neutral-600 disabled:text-black text-white bg-ncBlue transition-all rounded-xl text-[0.75rem] hover:font-semibold hover:scale-[1.01]"
        ...
        >
          <p className="text-sm  text-neutral-700 hover:text-blue-400 cursor-pointer mx-auto">
            Register as Airline?
          </p>
        </div>
      </div>
...
const AirlineRegistration = ({
  ...
  return (
    <main className="bg-ncBlue flex justify-center w-full h-screen relative">
      ...
      <div className="md:w-2/3 lg:w-[60%] mx-auto rounded-md pb-4 bg-white shadow-md  p-4 my-auto">
        <Stepper
  ...
  return (
    <div className=" flex items-center justify-between w-2/3 mx-auto space-x-3 mb-2">
      <button
        ...
        className={cn(
          "bg-darkBlue group rounded-xl p-2 w-16 hover:w-32 h-10 transition-all ease-in-out duration-300 flex items-center justify-center text-white text-[0.725rem] gap-2 font-semibold hover:shadow-md",
          current === 1 && "hidden"
        )}
      >
      ...
      <button
        ...
        className={cn(
          "bg-lightPink group rounded-xl p-2 w-16 hover:w-32 h-10 transition-all ease-in-out duration-300 flex items-center justify-center text-white text-[0.725rem] gap-2 font-semibold hover:shadow-md",
          current === maxLength && "hidden"
        )}
      >
        Next{" "}
