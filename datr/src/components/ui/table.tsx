...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-slate-100/50 data-[state=selected]:bg-slate-100 dark:hover:bg-slate-200/50 dark:data-[state=selected]:bg-slate-800 group",
      className
    )}
    {...props}
  />
