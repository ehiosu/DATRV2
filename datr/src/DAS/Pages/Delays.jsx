...
import { DelayedFlightData, DelayedFlightsColumnDef, FlightDataTable } from '../../CPD/Components/DataTable'
...
export const Delays = () => {
  ...
  return (
    ...
    <Popover>
      ...
      <FlightDataTable data={DelayedFlightData} columns={DelayedFlightsColumnDef} nav={navto}/>
    </SearchPage>
    </section>
  )
}
