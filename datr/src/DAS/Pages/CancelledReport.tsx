...
import { CancelledReportsTable, DelayReportsTable } from '@/CPD/Components/DataTable.js';
export const CancelledReports = () => {
  ...
  return (
    <section className="w-full max-h-screen overflow-y-auto p-2 relative">
      ...
      <SearchPage heading={`Cancelled Flights for ${airline?.replace("_"," ")}`} SearchElement={()=><TerminalSelector/>}>
